...
|  |  |
|  **Flutter implementation**.<br><br>A project configured to use Beagle with Flutter. Here you will find a Back and Front end project configure to use Beagle with Flutter and a sample Screen<br><br>• Medium complexity<br>• Flutter <br>• Style<br><br><br>**[> Browse](BeagleSampleFlutter/)** <br><br>  | <img src="readme/screenshots/flutterexample.png" width="320" alt="FlexScreenBeagle sample demo">|
|  |  |
