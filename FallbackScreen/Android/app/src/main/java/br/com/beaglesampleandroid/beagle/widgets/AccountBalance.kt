...
package br.com.beaglesampleandroid.beagle.widgets

import android.view.View
import br.com.beaglesampleandroid.components.AccountBalance
    ...
    override fun buildView(rootView: RootView): View {
        return AccountBalance(rootView.getContext()).apply {
            observeBindChanges(rootView, this, value) { value ->
                value?.let { balance -> this.setValueBalance(balance) }
            }
        }
    }
}